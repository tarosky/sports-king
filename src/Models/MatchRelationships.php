 ...
 * @property-read EuropeGames $internationals
 * @property-read DomesticGames $domestics
...
SQL;
		...
		list( $home, $away ) = bk_match_teams( $match );
...
SQL;
	...
	public function search( $abroad = true, $query = '', $year = '', $month = '', $day = '', $league = '', $per_page = 10 ) {
		return array_map( function ( $row ) {
			...
			$league = \Tarosky\BasketBallKing\Statics\Leagues::get_league($ab, $l_id);
...
SQL;
	...
	public function __get( $name ) {
		switch ( $name ) {
			case 'domestics':
				return DomesticGames::instance();
				break;
			case 'internationals':
				return EuropeGames::instance();
				break;
			case 'matches':
